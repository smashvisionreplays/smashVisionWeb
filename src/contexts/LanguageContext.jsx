...
const translations = {
  en: {
    ...
    shareClipTitleModal: 'Share clip',
    shareClipOptionDescription: 'The clip as it is, 16:9. Best for WhatsApp and messages.',
    shareToStoryOptionDescription: 'Fitted to a 9:16 SmashVision frame so Instagram stories show the whole point.',
    shareSheetHint: 'Your phone will ask which app to share with.',
    shareClipFailed: 'Could not share the clip. Try downloading it instead.',
    downloadClipTitleModal: 'Download clip',
    downloadClipOption: 'Download clip',
    downloadClipOptionDescription: 'The clip as it is, 16:9.',
    downloadStoryOption: 'Download for Instagram story',
    downloadStoryOptionDescription: 'Fitted to a 9:16 SmashVision frame, ready to post as a story.',
    downloadStoryHint: 'Send it to your phone to post it, or upload it from Instagram on this computer.',
    downloadStoryFailed: 'Could not prepare the story version. Please try again.',
    storyBusyRetry: 'Too many clips are being prepared right now. Try again in a moment.',
  ...
  es: {
    ...
    shareToStory: 'Compartir a historia',
    preparingStory: 'Preparando historia...',
    shareClipTitleModal: 'Compartir clip',
    shareClipOptionDescription: 'El clip tal cual, 16:9. Ideal para WhatsApp y mensajes.',
    shareToStoryOptionDescription: 'Ajustado a un marco SmashVision 9:16 para que la historia de Instagram muestre el punto completo.',
    shareSheetHint: 'Tu teléfono te preguntará con qué app compartir.',
    shareClipFailed: 'No se pudo compartir el clip. Intenta descargarlo.',
    downloadClipTitleModal: 'Descargar clip',
    downloadClipOption: 'Descargar clip',
    downloadClipOptionDescription: 'El clip tal cual, 16:9.',
    downloadStoryOption: 'Descargar para historia de Instagram',
    downloadStoryOptionDescription: 'Ajustado a un marco SmashVision 9:16, listo para publicar como historia.',
    downloadStoryHint: 'Envíalo a tu teléfono para publicarlo, o súbelo desde Instagram en esta computadora.',
    downloadStoryFailed: 'No se pudo preparar la versión para historia. Intenta de nuevo.',
    storyBusyRetry: 'Se están preparando muchos clips en este momento. Intenta de nuevo en un momento.',
