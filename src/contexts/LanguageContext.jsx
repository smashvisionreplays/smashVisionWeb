...
const translations = {
  en: {
    ...
    deleteClipWarning: 'This action is permanent. The clip will be removed from Cloudflare and your account.',
  ...
  es: {
    ...
    deleteClipWarning: 'Esta acción es permanente. El clip será eliminado de Cloudflare y de tu cuenta.',
