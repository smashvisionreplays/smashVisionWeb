...
export default function Footer() {
  ...
  const tagline = language === 'es'
    ? 'Revive cada punto. Comparte cada momento.'
    : 'Relive every point. Share every moment.';
    ...
    <footer className="bg-black/20 backdrop-blur-sm border-t border-white/10 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          {/* Contact */}
          <div className="flex flex-col gap-3">
            <p className="text-white font-semibold text-sm tracking-wide">{t('contactUs')}</p>
            <a
              href="mailto:admin@smashvisionapp.com"
              className="flex items-center gap-2 text-white/50 hover:text-[#DDF31A] text-sm transition-colors"
            >
              ...
              admin@smashvisionapp.com
            </a>
            <a
              href="https://wa.me/573138152250"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/50 hover:text-[#25D366] text-sm transition-colors"
            >
          ...
          {/* Legal */}
          <div className="flex flex-col gap-3">
            <p className="text-white font-semibold text-sm tracking-wide">Legal</p>
            <Link to="/terms/privacy-policy" className="text-white/50 hover:text-[#DDF31A] text-sm transition-colors">
              {t('privacyPolicy')}
            </Link>
            <Link to="/terms/terms-and-conditions" className="text-white/50 hover:text-[#DDF31A] text-sm transition-colors">
              {t('termsOfUse')}
            </Link>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6 flex items-center justify-center">
          <p className="text-white/30 text-xs">© 2026 SmashVision. {language === 'es' ? 'Todos los derechos reservados.' : 'All rights reserved.'}</p>
        </div>
